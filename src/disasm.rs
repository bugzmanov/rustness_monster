...
impl Disasm {
    ...
    pub fn new(program: &[u8], start: usize) -> Self {
        ...
        while begin < program.len() {  //todo: should be another condition as well
...
mod test {
    ...
    fn test_slice() {
        ...
        let result= vec!("0000: LDX #$08", "0002: DEX", "0003: INY", "0004: CPX #$03", "0006: BNE $0002", "0008: BRK", "0009: LDX #$08", "000b: DEX", "000c: INY", "000d: CPX #$03", "000f: BNE $000b", "0011: BRK");
        assert_eq!(asm.program, result);
