...
lazy_static! {
   pub static ref CPU_OPS_CODES: Vec<OpsCode> = vec![
       ...
       http://www.oxyron.de/html/opcodes02.html */
        ...
        OpsCode::new(0x1c, "IGN", 3, 4 /*or 5*/, AddressingMode::Absolute_X_PageCross),
        OpsCode::new(0x3c, "IGN", 3, 4 /*or 5*/, AddressingMode::Absolute_X_PageCross),
        OpsCode::new(0x5c, "IGN", 3, 4 /*or 5*/, AddressingMode::Absolute_X_PageCross),
        OpsCode::new(0x7c, "IGN", 3, 4 /*or 5*/, AddressingMode::Absolute_X_PageCross),
        OpsCode::new(0xdc, "IGN", 3, 4 /* or 5*/, AddressingMode::Absolute_X_PageCross),
        OpsCode::new(0xfc, "IGN", 3, 4 /* or 5*/, AddressingMode::Absolute_X_PageCross),
